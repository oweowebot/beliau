...
exports.smsg = (conn, m, hasParent) => {
     ...
     */
     m.reply = async (text, chatId, options) => {
        ...
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: 'Group', body: `Click Here!`, sourceUrl: 'https://chat.whatsapp.com/BgKpySEngapLoJ3IVNCh', thumbnail: data }}, options })
    }
